  ...
  return (
    ...
    >
      ...
      <div className="w-4/5 text-center flex justify-between items-center">
        <div className=" w-1/2 flex flex-col gap-10">
          <h2 className=" text-4xl font-titleFont text-gray-800 text-start">
            <span className=" font-semibold text-5xl">Step 1</span> Enter
          ...
          <div className="flex justify-between items-center">
            <Link to="/paytable">
              <button className=" w-56 h-10 bg-sky-700 rounded-full text-white flex justify-center items-center text-center">
      ...
      <div className="w-4/5 text-center flex justify-between items-center">
        ...
        <div className=" w-1/2 flex flex-col gap-10">
          <h2 className=" text-4xl font-titleFont text-gray-800 text-start">
            <span className=" font-semibold text-5xl">Step 2</span> Enter your
            bank details{" "}
          </h2>
          <p className=" text-gray-600 font-bodyFont text-start">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cupiditate
          ...
          <div className="flex justify-between items-center">
            <button className=" w-56 h-10 bg-sky-700 rounded-full text-white flex justify-center items-center text-center px-6">
              <span>Enter Details</span>
            </button>
          </div>
        </div>
